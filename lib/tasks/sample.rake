...
namespace :db do
  ...
  task sample_data: :environment do
    ...
    repo = Repository.create({ origin: "Foo",
                               archive: "Bar",
                               component: "Baz" })
    ...
    ConcretePackageVersion.create({ system: vm1,
                                    package_version: vim_base,
                                    concrete_package_state: update_installed })
    ConcretePackageVersion.create({ system: vm1,
                                    package_version: vim_upd,
                                    concrete_package_state: update_available })
    ConcretePackageVersion.create({ system: vm1,
                                    package_version: dnsutils_base,
                                    concrete_package_state: update_installed })
    ConcretePackageVersion.create({ system: vm1,
                                    package_version: dnsutils_upd,
                                    concrete_package_state: update_queued })
