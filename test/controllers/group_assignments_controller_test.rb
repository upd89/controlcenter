...
class GroupAssignmentsControllerTest < ActionController::TestCase
  ...
  test "should create group_assignment" do
    assert_difference('GroupAssignment.count') do
      post :create, group_assignment: { package_group_id: @group_assignment.package_group_id, package_id: @group_assignment.package_id }
    end
  ...
  test "should update group_assignment" do
    patch :update, id: @group_assignment, group_assignment: { package_group_id: @group_assignment.package_group_id, package_id: @group_assignment.package_id }
    assert_redirected_to group_assignment_path(assigns(:group_assignment))
  end
